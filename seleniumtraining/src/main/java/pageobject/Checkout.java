...
public class Checkout {
	...
	public static By enter_fname = By.xpath("//input[@id='first-name']");
	public static By enter_lname = By.xpath("//input[@id='last-name']");
	public static By enter_postal = By.xpath("//input[@id='postal-code']");
