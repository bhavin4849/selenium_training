...
public class TestCase1 extends TestCaseBase{
		public void verify_login_functionality()
		{
			...
			driver.findElement(Checkout.enter_fname).sendKeys("Testf");
			driver.findElement(Checkout.enter_lname).sendKeys("Testl");
			driver.findElement(Checkout.enter_postal).sendKeys("123456");
